...
/* Dimensions number*/
#define num_state_variable              3     // number of state variables x in original ODE systems
#define num_state_redundant             4
#define num_state_redundant_advance     10
#define num_reference_input             2
#define num_uncertain_parameter         2
#define samples                         3
#define num_loop                        2
#define num_uncertainties               4
...
#define NOUT  11//749//850//840//574//765              /* number of output times */
