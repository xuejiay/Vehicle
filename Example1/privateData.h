...
/* Dimensions number*/
#define num_state_variable              2     // number of state variables x in original ODE systems
#define num_state_redundant             3
#define num_state_redundant_advance     5
#define num_reference_input             1
#define num_uncertain_parameter         1
#define samples                         10
#define num_loop                        2
#define num_uncertainties               3
